...
<head>
    ...
    <meta name="description"
        content="Claricent Company Limited is a leading construction company in Ghana, providing high-quality building and infrastructure services.">
    <meta name="keywords" content="construction, Ghana, building, infrastructure, Claricent">
    <meta name="author" content="">
    <!-- Page Title -->
    <title>Claricent Company Limited - Best Construction Company in Ghana</title>
    <!-- Favicon Icon -->
                ...
                <div class="swiper-wrapper">
                                        ...
                                        <div class="hero-content">
                                            <div class="section-title">
                                                ...
                                                <p class="wow fadeInUp" data-wow-delay="0.25s">we specialize in turning
                                                    visions into reality with exceptional craftsmanship and meticulous
                                                    attention to detail. With years of experience and a commitment to
                                                    quality.</p>
                                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="hero-slide">
                            <!-- Slider Image Start -->
                            <div class="hero-slider-image">
                                <img src="images/claricent-bg-1.jpeg" alt="">
                            </div>
                            <!-- Slider Image End -->
                ...
                <div class="col-lg-7">
                    ...
                    <div class="about-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-3" data-cursor="-opaque">Crafting structures that last a
                                lifetime</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.25s">Crafting structures that last a lifetime
                                requires a holistic approach that integrates advanced materials, resilient design,
                                regular maintenance, and sustainability practices. By learning from historical examples
                                and leveraging modern technology.</p>
                        </div>
                        <!-- Section Title End -->
                        ...
                        <div class="about-content-footer wow fadeInUp" data-wow-delay="0.75s">
                            ...
                            <div class="about-contact-support">
                                <div class="icon-box">
                                    <img src="https://html.awaikenthemes.com/builtup/images/icon-phone.svg" alt="">
                                </div>
                                <div class="about-us-support-content">
                                    <p>Call support center 24X7</p>
                                    <h3>+233 243368425, <br>+233 500153340, <br>+233 209128276</h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="service-item wow fadeInUp" data-wow-delay="0.25s">
                            ...
                            <div class="service-image" data-cursor-text="View">
                                <a href="#">
                                    <figure>
                                        <img src="images/claricent-bg-4.jpeg" alt="">
                                    </figure>
                                </a>
                            </div>
                            <!-- Service Image End -->
                            ...
                            <div class="service-body">
                                ...
                                <div class="service-content">
                                    <p>We deliver high-quality construction solutions for residential and commercial
                                        buildings, as well as road and infrastructure projects, ensuring durability,
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="service-item wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <div class="service-image" data-cursor-text="View">
                                <a href="#">
                                    <figure>
                                        <img src="images/claricent-bg-3.jpeg" alt="">
                                    </figure>
                                </a>
                            </div>
                            <!-- Service Image End -->
                            ...
                            <div class="service-body">
                                ...
                                <!-- Service Content Start -->
                                <div class="service-content">
                                    <p>Our engineering services provide innovative and reliable civil and structural
                                        solutions, focused on efficient design, structural stability, and long-term
                                        performance of projects.</p>
                                    <!-- <div class="service-content-footer">
                                        <a href="#" class="readmore-btn">view more</a>
                                    </div> -->
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="service-item wow fadeInUp" data-wow-delay="0.75s">
                            ...
                            <div class="service-body">
                                ...
                                <!-- Service Content Start -->
                                <div class="service-content">
                                    <p>We offer end-to-end project management services, overseeing planning,
                                        coordination, budgeting, and execution to ensure infrastructure projects are
                                        completed on time, within budget, and to specification.</p>
                                    <!-- <div class="service-content-footer">
                                        <a href="#" class="readmore-btn">view more</a>
                                    </div> -->
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="service-item wow fadeInUp" data-wow-delay="1s">
                            ...
                            <div class="service-image" data-cursor-text="View">
                                <a href="#">
                                    <figure>
                                        <img src="images/claricent-bg-10.jpeg" alt="">
                                    </figure>
                                </a>
                            </div>
                            <!-- Service Image End -->
                            ...
                            <div class="service-body">
                                <!-- Service Body Title Start -->
                                <div class="service-body-title">
                                    <h3>Design & Build / Planning</h3>
                                </div>
                                <!-- Service Body Title End -->

                                <!-- Service Content Start -->
                                <div class="service-content">
                                    <p>We provide integrated design and build services, including architectural designs,
                                        building plans, and detailed structural drawings, delivering seamless project
            ...
            <div class="row section-row">
                <div class="col-lg-12">
                    ...
                    <div class="section-title">
                        ...
                        <p class="wow fadeInUp" data-wow-delay="0.25s">Developed in close collaboration with our
                            partners and clients, combines industry knowledge, decades of experience, ingenuity and
                            adaptability to deliver excellence to our clients.</p>
                    </div>
                    <!-- Section Title End -->
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="why-choose-item wow fadeInUp" data-wow-delay="0.25s">
                        <div class="icon-box">
                            <img src="https://html.awaikenthemes.com/builtup/images/icon-why-choose-1.svg" alt="">
                        </div>
                        <div class="why-choose-content">
                            <h3>innovation solutions</h3>
                            <p>We apply innovative construction methods and modern technologies to develop smart,
                                cost-effective, and sustainable solutions tailored to meet the unique needs of each
                                project.</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="why-choose-item wow fadeInUp" data-wow-delay="0.25s">
                        <div class="icon-box">
                            <img src="https://html.awaikenthemes.com/builtup/images/icon-why-choose-2.svg" alt="">
                        </div>
                        <div class="why-choose-content">
                            <h3>quality craftsmanship</h3>
                            <p>Our commitment to quality craftsmanship is reflected in the use of skilled professionals,
                                premium materials, and strict quality control standards to deliver durable, safe, and
                                aesthetically refined projects.</p>
                        </div>
                        <div class="why-choose-counter">
                            <h3><span class="counter">800</span>+</h3>
                            <p>project complated</p>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="why-choose-item wow fadeInUp" data-wow-delay="0.25s">
                        <div class="icon-box">
                            <img src="https://html.awaikenthemes.com/builtup/images/icon-why-choose-3.svg" alt="">
                        </div>
                        <div class="why-choose-content">
                            <h3>expertise and experience</h3>
                            <p>We bring extensive industry knowledge and hands-on experience to every project, ensuring
                                efficient execution, technical accuracy, and reliable results across diverse
                                construction and engineering works.</p>
                        </div>
                        <div class="why-choose-counter">
                            <h3><span class="counter">800</span>+</h3>
                            <p>project complated</p>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 col-md-4">
                    ...
                    <div class="cta-box-image">
                        <figure>
                            <img src="https://html.awaikenthemes.com/builtup/images/cta-box-img.png" alt="">
                        </figure>
                    </div>
                    <!-- Cta Box Image End -->
                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <div class="testimonial-header">
                                            ...
                                            <div class="testimonial-content">
                                                <p>Claricent Company Ltd, I want to sincerely thank you for transforming
                                                    our inherited family house into a true dream home. What was once
                                                    just a structure filled with memories is now a beautifully designed
                                                    space where my siblings and I can come together, share life, and
                                                    create new stories. Your attention to detail, professionalism, and
                                                    ability to blend modern comfort with the home’s original character
                                                    exceeded our expectations. You didn’t just renovate a house—you gave
                                                    us a legacy we can all cherish.</p>
                                            </div>
                                        </div>
                                        <div class="testimonial-body">
                                            <div class="author-image">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <div class="testimonial-header">
                                            ...
                                            <div class="testimonial-content">
                                                <p>Claricent Company Ltd, I extend my sincere appreciation for the
                                                    diligence and craftsmanship invested in this project. The building
                                                    stands firm, functional, and fit for its intended purpose. Your
                                                    professionalism and attention to detail reflect a standard worthy of
                                                    commendation. May your company continue to uphold such excellence in
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <div class="testimonial-header">
                                            ...
                                            <div class="testimonial-content">
                                                <p>As a young professional stepping into business while also beginning a
                                                    family, I value spaces that reflect both ambition and warmth.
                                                    Claricent Company Ltd’s reputation for innovative construction and
                                                    engineering solutions gives me confidence that my vision of a modern
                                                    yet welcoming home can be realized. I’m particularly drawn to your
                                                    emphasis on beautiful designs that balance functionality with
                                                    elegance. I look forward to collaborating with your team to create a
                                                    space that not only supports my growing family but also inspires my
                    ...
                    <div class="our-faqs-images">
                        <div class="row align-items-end">
                            <div class="col-md-6 col-6">
                                ...
                                <div class="faqs-img-1">
                                    <figure class="image-anime reveal">
                                        <img src="images/claricent-bg-15.jpeg" alt="">
                                    </figure>
                                </div>
                                <!-- FAQs Img End -->
                            </div>
                        ...
                        <div class="row align-items-start">
                            <div class="col-md-6 col-6">
                                ...
                                <div class="faqs-img-1">
                                    <figure class="image-anime reveal">
                                        <img src="https://html.awaikenthemes.com/builtup/images/our-faqs-img-3.jpg"
                                            alt="">
                                    </figure>
                                </div>
                                <!-- FAQs Img End -->
                        ...
                        <div class="our-faqs-bulitup">
                            <img src="images/CLARICENT_COMPANY_LIMITED_LOADER.png" alt="">
                        </div>
                    </div>
                    <!-- Our FAQs Images End -->
                </div>
                    ...
                    <div class="faq-accordion" id="accordion">
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.25s">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body">
                                    <p>We provide construction, engineering solutions, project management, design &
                                        build, maintenance, and consultancy services for residential, commercial, and
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                data-bs-parent="#accordion">
                                <div class="accordion-body">
                                    <p>Yes, we undertake residential, commercial, and infrastructure projects of varying
                                        sizes and complexity.</p>
                                </div>
                            </div>
                        </div>
                        <!-- FAQ Item End -->
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.75s">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                data-bs-parent="#accordion">
                                <div class="accordion-body">
                                    <p>We follow industry standards, use skilled professionals, quality materials, and
                                        strict safety and quality control procedures.</p>
                                </div>
                            </div>
                        </div>
                        <!-- FAQ Item End -->
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="1s">
                            <h2 class="accordion-header" id="headingfour">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    Do you provide design and consultancy services?
                                </button>
                            </h2>
                            <div id="collapsefour" class="accordion-collapse collapse" aria-labelledby="headingfour"
                                data-bs-parent="#accordion">
                                <div class="accordion-body">
                                    <p>Yes, we offer complete design, planning, and consultancy services including
                                        structural assessments and soil testing.</p>
                                </div>
                            </div>
                        </div>
                        <!-- FAQ Item End -->
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="1s">
                            ...
                            <div id="collapsefour" class="accordion-collapse collapse" aria-labelledby="headingfour"
                                data-bs-parent="#accordion">
                                <div class="accordion-body">
                                    <p>Simply contact us for a consultation or site inspection, and we’ll guide you
            ...
            <div class="row align-items-center">
                <div class="col-lg-4 col-md-5">
                    ...
                    <div class="contact-sidebar wow fadeInUp" data-wow-delay="0.25s">
                        ...
                        <div class="contact-info">
                            <div class="icon-box">
                                <img src="https://html.awaikenthemes.com/builtup/images/icon-mail.svg" alt="">
                            </div>
                            <div class="contact-info-content">
                                <p>write to us</p>
                                <h3>info@claricentgroup.com</h3>
                            </div>
                        </div>
                        <!-- Contact Info End -->
                        ...
                        <div class="contact-info-image">
                            <figure>
                                <img src="images/get-in-touch-2.png" alt="">
                            </figure>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="contact-form-buttons">
                                        ...
                                        <button type="button" class="btn-default btn-whatsapp" id="whatsappBtn">
                ...
                <div class="col-lg-3 col-md-12">
                    ...
                    <div class="about-footer">
                        ...
                        <div class="footer-logo">
                            <figure>
                                <img src="images/CLARICENT_COMPANY_LIMITED_FULL_LOGO.png" alt="">
                            </figure>
                        </div>
                        <!-- Footer Logo End -->
                        ...
                        <div class="footer-content">
                            <p>Claricent Company Limited delivers innovative construction and engineering solutions that
                                transform Ghana’s built environment.</p>
                        </div>
                        <!-- Footer Content End -->
                    </div>
                ...
                <div class="col-lg-3 col-md-4 col-12">
                    ...
                    <div class="footer-links footer-contact-box">
                        ...
                        <div class="footer-info-box">
                            <!-- Icon Box Start -->
                            <div class="icon-box">
                                <img src="https://html.awaikenthemes.com/builtup/images/icon-location.svg" alt="">
                            </div>
                            <!-- Icon Box End -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-7">
                        ...
                        <div class="footer-copyright-text">
                            <p>Copyright © 2026 Basitech Solutions. All Rights Reserved.</p>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-5">
                        ...
                        <div class="footer-social-links">
                            <ul>
                                <li><a href="https://www.instagram.com/jeriscot/"><i
                                            class="fa-brands fa-instagram"></i></a></li>
                                <li><a href="https://www.facebook.com/jeriscot/"><i
